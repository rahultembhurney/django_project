    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('membership_status', models.CharField(choices=[('S', 'SILVER'), ('B', 'BRONZE'), ('G', 'GOLD')], default='B', max_length=1)),
            ],
        ),
        migrations.CreateModel(
            name='Order',
            fields=[
                ...
                ('payment_status', models.CharField(choices=[('C', 'PAYMENT_COMPLETE'), ('D', 'PAYMENT_DECLINED'), ('P', 'PAYMENT_PENDING')], default='P', max_length=1)),
